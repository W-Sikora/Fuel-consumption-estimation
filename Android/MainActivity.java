    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                if(i>0) {
                    textView2.setText(calculation.showLast());
                    sendPost();
                }
                else {
                    i = i + 1;
...
//        locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 10000, 0, (LocationListener) locationListener);
